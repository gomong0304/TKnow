...
function App() {
	return (
		...
		// 티켓 페이지 (헤더랑 푸터 없는 화면)
				...
				<Route path="/Ticket/Buy2" element={<TicketBuy2 />} />
				<Route path="/Ticket/Buy3" element={<TicketBuy3 />} />
				<Route path="/Ticket/Buy4" element={<TicketBuy4 />} />
				<Route path="/Ticket/Buy5" element={<TicketBuy5 />} />
				<Route path="/Ticket/Buy6" element={<TicketBuy6 />} />
