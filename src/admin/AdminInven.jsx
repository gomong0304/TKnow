						...
						<table className="admin-member-text1">
							<tbody>
								...
								{tickets.length > 0 ? (
										...
										<tr key={t.id}>
											{editingId === t.id ? (
												<>
													...
													<td><input name="concertName" value={formData.concertName} onChange={handleChange} /></td>
													<td><input name="price" value={formData.price} onChange={handleChange} /></td>
													<td><input name="remainingSeats" value={formData.remainingSeats} onChange={handleChange} /></td>
													<td><input name="status" value={formData.status} onChange={handleChange} /></td>
													<td>
														<button onClick={() => handleSave(t.id)}>저장</button>
									...
									<tr><td colSpan="6">불러올 티켓이 없습니다</td></tr>
								)}
							</tbody>
						</table><br /><br />
