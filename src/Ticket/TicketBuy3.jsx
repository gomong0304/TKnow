				...
				<div className="ticket-buy-middle">
						...
						<div className="ticket-buy3-middle-box1">
							<div className="ticket-buy3-box">
								<p className="ticket-buy3-box2">
									...
									<strong>R 석</strong> ｜
									<strong style={{ color: "#85292B" }}>좌석 1 매 </strong> 를 선택하였습니다.</p>
								<br />
								<table>
									<thead>
										<tr><th>기본가</th><td>일반</td><td>163,000 원</td>
											<select name="fruit">
												<option value="">0 매</option>
												<option value="apple">1 매</option>
												<option value="banana">2 매</option>
												<option value="strawberry">3 매</option>
											</select></tr>
									</thead>
									
									<tbody>
										<tr><th>기본 할인</th><td>장애인 할인 ( 1 ~ 3 급 (중증)/ 동반 1 인) 20 %</td><td>114,000 원</td>
											<select name="fruit">
												<option value="">0 매</option>
												<option value="apple">1 매</option>
												<option value="banana">2 매</option>
										...
										<tr><th>기본 할인</th><td>장애인 할인 ( 4~ 6 급 (경증)/ 본인만) 20 %</td><td>114,000 원</td>
											<select name="fruit">
												<option value="">0 매</option>
												<option value="apple">1 매</option>
												<option value="banana">2 매</option>
										...
										<tr><th>기본 할인</th><td>국가유공자 (본인만) 20 %</td><td>114,000 원</td>
											<select name="fruit">
												<option value="">0 매</option>
												<option value="apple">1 매</option>
												<option value="banana">2 매</option>
					...
					<div className="ticket-set-setting2">
						...
						<div className="ticket-stage-button2">
							<Link to="/Ticket/Buy2" className="ticket-stage-back">
								이전 단계
							</Link>


							<Link to="/Ticket/Buy4" className="ticket-stage-next3">
								다음 단계
							</Link>
						</div>
					</div>
